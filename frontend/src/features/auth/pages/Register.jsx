    ...
    <div className="min-h-screen flex items-center justify-center text-white">
      ...
      <div className="w-full max-w-md bg-neutral-800 rounded-2xl shadow-lg p-8">
        ...
        <a
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white hover:bg-neutral-100 text-neutral-900 rounded-xl font-medium transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg mb-4"
        >
