    ...
    <>
      ...
      <div
        className={`${sidebarOpen ? 'w-72 translate-x-0' : 'w-0 -translate-x-full lg:translate-x-0'
          } fixed lg:relative z-50 bg-gradient-to-b from-neutral-900 to-neutral-950 text-white transition-all duration-300 ease-in-out overflow-hidden flex flex-col border-r border-neutral-800/50 h-full`}
      >
        <div className="flex p-3 justify-between items-center">
          <div onClick={() => navigatepage('/')} className="p-1 bg-black rounded-full cursor-pointer">
            <img src={cvlogo} className="w-8 h-8" alt="Logo" />
          </div>
          <button
            onClick={toggleSidebar}
            className="p-2 hover:bg-neutral-800 rounded-xl transition-all duration-200 lg:hidden text-neutral-400 hover:text-white"
          >
            <X size={20} />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-3 py-4 space-y-1 custom-scrollbar">
          ...
          {hasMore && (
            <button
              ...
              className="mx-auto flex items-center justify-center gap-3 px-4 py-1 mt-4 text-xs bg-neutral-800 hover:bg-neutral-700 rounded-lg transition-all duration-200 border border-neutral-700 text-neutral-400"
            >
              Load More
            </button>
          )}
        ...
        <div className="p-4 border-t border-neutral-800/50 bg-neutral-900/50">
          ...
          <div
            ...
            className="mb-2 px-3 py-2.5 hover:bg-neutral-800/70 rounded-xl transition-all duration-200 cursor-pointer group"
          >
          ...
          <div
            ...
            className="mt-4 px-3 py-2.5 hover:bg-red-500/10 rounded-xl transition-all duration-200 cursor-pointer group"
          >
            <div className="flex items-center gap-3">
